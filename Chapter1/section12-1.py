...
conn = sqlite3.connect('C:/Users/vivia/OneDrive/바탕 화면/FastCampus/Chapter1/resource/database.db', isolation_level=None)
...
# 데이터 삽입
c.execute("INSERT INTO users VALUES(1, 'Kim', 'Kim@naver.com', '010-2312-1234', 'Kim.com', ?)", (nowDatetime,))
